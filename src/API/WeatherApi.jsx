...
export default function WeatherApi() {
  ...
  useEffect(() => {
    const fetchWeatherData = async () => {
      try {
        ...
        const apiUrl = `http://api.weatherapi.com/v1/current.json?key=db3b549960994f87ac5143034243107&q=${city}`;
  ...
  return (
    <div style={{ textAlign: 'center', marginTop: '20px' }} id="weather">
      ...
      <img src={imageSrc} alt={conditionText} style={{ width: '300px', height: 'auto', marginBottom: '20px' }} />
      {weatherData && (
        <div>
